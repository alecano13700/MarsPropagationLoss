 ...
 */
class MarsPropagationLossModel : public PropagationLossModel
{
public:
    /**
     * \brief Get the type ID.
    ...
    /**
     * \param n the total particle density.
     * Set the total particle density.
     */
    void SetN_T (double n);

    /**
     * \param n the mean particle radius.
     * Set the mean particle radius.
     */
    void SetParticleRadius (double n);

    /**
     * \param n the real part of the dielettric permittivity of dust particles.
     * Set the real part of the dielettric permittivity of dust particles.
     */
    void SetEpsilonReal (double n);

    /**
     * \param n the imaginary part of the dielettric permittivity of dust particles.
     * Set the imaginary part of the dielettric permittivity of dust particles.
     */
    void SetEpsilonImm (double n);

    /**
     * \param n the wavelenght.
     * Set the wavelenght.
     */
    void SetLambda (double n);
    ...
    /**
     * \returns the wavelenght.
     */
    double GetLambda (void) const;

    /**
     * \returns the real part of the dielettric permittivity of dust particles.
     */
    double GetEpsilonReal (void) const;

    /**
     * \returns the imaginary part of the dielettric permittivity of dust particles.
     */
    double GetEpsilonImm (void) const;

    /**
     * \returns the distance between Tx and Rx.
     */
...
private:
     ...
     * Defined and unimplemented to avoid misuse
     */
    MarsPropagationLossModel (const MarsPropagationLossModel &);
    /**
     * \brief Copy constructor
     *
     * Defined and unimplemented to avoid misuse
     * \returns
     */
    MarsPropagationLossModel & operator = (const MarsPropagationLossModel &);
    ...
    /**
     *  Creates a default reference loss model
     * \return a default reference loss mmodel
     */
    static Ptr<PropagationLossModel> CreateDefaultReference (void);
